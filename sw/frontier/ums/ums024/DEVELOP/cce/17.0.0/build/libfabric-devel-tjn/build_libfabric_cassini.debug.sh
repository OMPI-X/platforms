...
MY_OFI_PREFIX=$MY_UMS_BASE_DIR/$COMPILER/$COMPILER_VER/install/libfabric-${ofi_ver}${frontier_release}-${build_date}${DBGEXT}
OFI_SOURCE_DIR=$MY_UMS_BASE_DIR/source/libfabric-${ofi_ver}${frontier_release}
...
echo "module use $MY_UMS_BASE_DIR/$COMPILER/$COMPILER_VER/modules"
...
#---
# TJN: 2aug2024 - Load our json-c last to ensure we appear
#                 at head of PKG_CONFIG_PATH and win on any pkg-config
#                 checks, otherwise we could end up with /usr items instead
#---
module load json-c/0.17

#echo "#####"
#echo "DBG: pkg-config json-c info..."
#pkg-config --variable=prefix json-c
#echo "#####"
...
if [ ! -d "$MY_UMS_BASE_DIR/$COMPILER/$COMPILER_VER/modules" ] ; then
...
${OFI_SOURCE_DIR}/configure \
    ...
    --verbose \
    CFLAGS="-O0 -g -ggdb -D__SSE4_1__ -D__HIP_PLATFORM_HCC__ -I ${ROCM_PATH}/include -I${MY_JSONC_DIR}/include " \
