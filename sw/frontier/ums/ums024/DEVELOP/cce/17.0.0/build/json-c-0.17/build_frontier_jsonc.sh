...
MY_JSONC_PREFIX=$MY_UMS_BASE_DIR/$COMPILER/$COMPILER_VER/install/json-c-${jsonc_ver}-${build_date}${DBGEXT}
...
if [ ! -f "../../../../source/json-c-${jsonc_ver}/cmake-configure" ] ; then
    echo "ERROR: Failed sanity check on JSON-C cmake-configure file!"
    echo "  Missing: ../../../../source/json-c-${jsonc_ver}/cmake-configure"
    exit 1
fi
...
../../../../source/json-c-${jsonc_ver}/cmake-configure \
    --prefix=${JSONC_INSTALL_DIR} \
    CC=craycc CXX=craycxx \
    CMAKE_C_FLAGS=-Wno-deprecated-non-prototype \
